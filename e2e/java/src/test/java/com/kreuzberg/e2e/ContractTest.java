...
public class ContractTest {
  ...
  @Test
  public void configLlmStructuredExtraction() throws Exception {
    JsonNode config =
        MAPPER.readTree(
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/pdf"));
          E2EHelpers.Assertions.assertMinContentLength(result, 10);
          E2EHelpers.assertStructuredOutput(result, true, null, null);
        });
  }

  @Test
  public void configLlmStructuredExtractionWithPrompt() throws Exception {
    JsonNode config =
        MAPPER.readTree(
            "{\"structured_extraction\":{\"schema\":{\"type\":\"object\",\"properties\":{\"sender\":{\"type\":\"string\"},\"recipient\":{\"type\":\"string\"},\"subject\":{\"type\":\"string\"}},\"required\":[\"sender\",\"recipient\"]},\"schema_name\":\"memo_parties\",\"prompt\":\"Extract"
                + " the sender and recipient from this memo document. If not found, use"
                + " 'unknown'.\",\"llm\":{\"model\":\"openai/gpt-4o\"}}}");
    E2EHelpers.skipIfFeatureUnavailable("liter-llm");
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/pdf"));
          E2EHelpers.Assertions.assertMinContentLength(result, 10);
          E2EHelpers.assertStructuredOutput(
              result, true, null, new String[] {"sender", "recipient"});
        });
  }

  @Test
  public void configLlmVlmOcr() throws Exception {
    JsonNode config =
        MAPPER.readTree(
