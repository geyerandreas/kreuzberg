...
const DOCS: &[BenchDoc] = &[
    ...
    // Vision-based GT documents (generated by Haiku vision, reviewed by Opus)
    BenchDoc {
        name: "memo",
        pdf_path: "pdf/fake_memo.pdf",
        gt_path: "ground_truth/pdf/fake_memo_vision.md",
        docling_path: None,
    },
    BenchDoc {
        name: "receipt",
        pdf_path: "vendored/markitdown/RECEIPT-2024-TXN-98765_retail_purchase.pdf",
        gt_path: "ground_truth/pdf/receipt_vision.md",
        docling_path: None,
    },
    BenchDoc {
        name: "scotus-transcript",
        pdf_path: "vendored/pdfplumber/pdfs/scotus-transcript-p1.pdf",
        gt_path: "ground_truth/pdf/scotus_transcript_vision.md",
        docling_path: None,
    },
    BenchDoc {
        name: "borderless-table",
        pdf_path: "vendored/markitdown/SPARSE-2024-INV-1234_borderless_table.pdf",
        gt_path: "ground_truth/pdf/borderless_table_vision.md",
        docling_path: None,
    },
    BenchDoc {
        name: "french-minutes",
        pdf_path: "vendored/pdfplumber/pdfs/2023-06-20-PV.pdf",
        gt_path: "ground_truth/pdf/french_minutes_vision.md",
        docling_path: None,
    },
];
