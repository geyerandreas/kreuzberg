...
[Friedrich Kauffmann](/wiki/Friedrich_Kauffmann "Friedrich Kauffmann") classified Sinhtgunt as a [valkyrie](/wiki/Valkyrie "Valkyrie") in the 19th century, because the elements *-gund* and *-hild* appear frequently in their names.[\[9\]](#cite_note-9) Stefan Schaffner and Heiner Eichner more recently agreed with him, based on Günter Müller's paper on the valkyries' healing powers.[\[10\]](#cite_note-10)
...
8.  **[^](#cite_ref-8)** [Wolfgang Beck](/w/index.php?title=Wolfgang_Beck&action=edit&redlink=1). *Die Merseburger Zaubersprüche. Eine Einführung*. Pertersberg, 2010, pp. 163–171, here p. 171.
