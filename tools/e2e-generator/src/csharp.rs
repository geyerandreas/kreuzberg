...
const CSHARP_CSPROJ_TEMPLATE: &str = r#"<!-- Code generated by kreuzberg-e2e-generator. DO NOT EDIT. -->
...
fn write_csproj(root: &Utf8Path) -> Result<()> {
    let csproj_path = root.join("Kreuzberg.E2E.Tests.csproj");
    fs::write(csproj_path.as_std_path(), CSHARP_CSPROJ_TEMPLATE)
        .context("Failed to write Kreuzberg.E2E.Tests.csproj")?;
    Ok(())
}
